        ...
        <f7-popup class="fuel-popup" push>
            <f7-view>
                <f7-page>
                    ...
                    <f7-button v-on:click="saveFill()" v-bind:class="{ noActive: fuel.fillEdit.fuel === '0' }" raised fill round class="greenBtn orang">Сохранить</f7-button>
                </f7-page>
            </f7-view>
        </f7-popup>
    </f7-page>
...
<script>
    module.exports = {
        ...
        methods: {
            ...
            saveFill() {
                if (fuel.fillEdit.fuel === '0') { return }
